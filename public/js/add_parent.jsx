        ...
        return(
            <div className="marco form-box">
                ...
                <div className="medio fill">
                    ...
                    <div className="login">
                        <input id="ci" type="number" placeholder="Cédula del representante" className="input" style={{
                            width:"100%"
                        }}/>
                        <br />
                        <br />
                        ...
                        <Button
                            ...
                            click={() => {
                                ...
                                try {
                                    ...
                                    let result = MyServer.add_parent(parseInt(ci));
                                    ...
                                    switch (result.error) {
                                        ...
                                        case 3:
                                            ...
                                            break;
                                        case 10:
                                            msg(`La cédula ingresada ya existe en la lista de representantes`, "Cédula no valida");
                                            break;
                                        case 0:
                                            subapi.done(window);
                                            close()
